...
<section class="price">
  ...
  <div class="container">
    <div class="price-list">
      <span>
        Прайс-лист на ремонт тепловозов и электровоз <br>
        в УП "O'ztemiryolmasta'mir"
      </span>
    </div>
    <center>
      <style>
    ...
    <div class="buttons">
      <a id="btn-1" href="#"> <i class="fa fa-download" aria-hidden="true"></i> скачать категорию</a>
      <a id="btn-2" href="#"> <i class="fa fa-download" aria-hidden="true"></i> скачать все</a>
    </div>
    <div class="price-list">
      <span>
        Прайс-лист на ремонт локомативных колесных пар <br>
        УП "O'ztemiryolmasta'mir"
      </span>
    </div>
    <center>
      <table class="top">
...
<script src="{{asset('price/plugins/jq.js')}}">
</script>
